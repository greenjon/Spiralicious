...
- **Issue**: Sluggish performance or low frame rate
- **Solution**: Lower the quality settings, reduce the number of active modulators, or simplify complex mandalas

#### Audio Detection

- **Issue**: Beat detection not working consistently
- **Solution**: Adjust the beat detection sensitivity, ensure your audio source is properly connected, check volume levels

#### Saving Problems

- **Issue**: Changes not being saved
- **Solution**: Manually save via the menu, check if breadcrumb shows asterisk indicating unsaved changes

#### UI Navigation

- **Issue**: Can't find specific controls or features
- **Solution**: Use the search function, check the correct editor for the feature, consult this manual

#### Random Set Generation

- **Issue**: Generated mandalas don't match expectations
- **Solution**: Check constraint settings, ensure ranges aren't too narrow, verify default settings

### Support Resources

- **Community Forum**: Connect with other Spirals users
- **Tutorial Videos**: Step-by-step guides for common tasks
- **Issue Reporting**: Submit bug reports for technical issues
...
- **Constraining Randomness**: Narrow constraints for more consistent results
- **Polyrhythms**: Use different beat divisions for different parameters
- **Phasing**: Use similar but slightly different LFO times for evolving patterns
- **Harmonic Relations**: Set parameters to mathematically related values

### Performance Techniques

- **Gradual Build**: Start simple and layer complexity during performance
- **Dynamic Response**: Use audio reactivity to create responsive visuals
- **Transitional Effects**: Create smooth transitions between states
- **Anticipatory Changes**: Set up changes before audio cues for tight synchronization

### Optimization Strategies

- **Parameter Efficiency**: Focus modulation on high-impact parameters
- **Render Settings**: Balance quality and performance for your hardware
- **Preset Organization**: Create logical naming systems for quick recall
- **Template Libraries**: Build a personal library of starting points

### Audio Integration

- **Beat-Matching**: Align visual rhythms with audio beats
- **Frequency Mapping**: Map different audio frequencies to different parameters
- **Dynamic Range**: Use audio dynamics to control visual intensity
- **Spectral Effects**: Create specialized effects based on audio spectrum

### Advanced Techniques

- **Parameter Linking**: Create relationships between different parameters
- **Meta-Modulation**: Modulate modulator parameters
- **Composite Patterns**: Layer simple patterns to create complex results
- **Recursive Structures**: Create fractal-like patterns with nested modulation